...
interface ApiEndpoint {
    ...
    @GET("produkjual")
    fun getProdukjual(@Header("Authorization") token : String) : Call<ProdukResponse>
    ...
    @FormUrlEncoded
    @HTTP(method = "PUT", path = "produkbeli", hasBody = true)
    fun putProdukBeli(
        @Header("Authorization") token : String,
        @Field("id") id : Int,
        @Field("admin_id") admin_id : Int,
    ...
    @FormUrlEncoded
    @HTTP(method = "PUT", path = "produkjual", hasBody = true)
    fun putProdukJual(
        @Header("Authorization") token : String,
        @Field("id") id : Int,
        @Field("admin_id") admin_id : Int,
    ...
    @FormUrlEncoded
    @HTTP(method = "PUT", path = "produkjualdelete", hasBody = true)
    fun deleteProdukjual(
        @Header("Authorization") token : String,
        @Field("id") id : Int,
        @Field("admin_id") admin_id : Int,
        @Field("nama") nama : String,
